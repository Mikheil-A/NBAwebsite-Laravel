...
@section('title', 'Golden State Warriors')

<link href="{{ asset('css/pages/teams.css') }}" rel="stylesheet" />
<style>
  /*Navigation - the current/selected page*/
...
@section('article')
  <article>
    <img src="{{ asset('images/Team_backgrounds/warriors.jpg') }}" height="350" width="1085" />
          ...
          <tr>
            <td>
              <a href="{{ $row['nbacomUrl'] }}" target="_blank" title="{{ $row["fullname"] }}">
                <img src="{{ asset('images/Players/Warriors/' . $row["profilePhoto"]) }}" />
              </a>
            </td>
          </tr>
          <tr>
